...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::date-picker.input.index','data' => ['variant' => 'custom','placeholder' => $placeholder,'invalid' => $invalid,'size' => $size,'clearable' => $clearable,'dropdown' => $dropdown]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'custom','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($placeholder),'invalid' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($invalid),'size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($size),'clearable' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clearable),'dropdown' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dropdown)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <?php if ($presets): ?>
                    <ui-calendar-presets class="row-span-full max-sm:hidden border-e border-zinc-200 dark:border-zinc-600">
                        <ui-radio-group class="flex flex-col gap-1 p-2 min-w-[120px]">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $presetArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <ui-radio
                            ...
                            <?php if ($range): ?>
                                <div class="sm:px-2 flex items-center gap-4">
                                    <div class="flex items-center gap-2">
                                        <span class="max-sm:hidden text-sm font-medium text-zinc-800 dark:text-white"><?php echo e(__('Start')); ?></span>
                                        <ui-date-picker-trigger class="<?php echo e($bareInputClasses); ?>" data-bare>
                                            <div class="flex items-center" data-flux-date-inputs>
                                                <input type="text" inputmode="numeric" aria-label="<?php echo e(__('Day')); ?>" data-flux-day-input class="<?php echo e($dateInputClasses); ?> w-[calc(2ch+2px)]" />
                                                <input type="text" inputmode="numeric" aria-label="<?php echo e(__('Month')); ?>" data-flux-month-input class="<?php echo e($dateInputClasses); ?> w-[calc(2ch+2px)]" />
                                                <input type="text" inputmode="numeric" aria-label="<?php echo e(__('Year')); ?>" data-flux-year-input class="<?php echo e($dateInputClasses); ?> w-[calc(4ch+2px)]" />
                                            </div>
                                        </ui-date-picker-trigger>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="max-sm:hidden text-sm font-medium text-zinc-800 dark:text-white"><?php echo e(__('End')); ?></span>
                                        <ui-date-picker-trigger class="<?php echo e($bareInputClasses); ?>" data-bare>
                                            <div class="flex items-center" data-flux-date-inputs>
                                                <input type="text" inputmode="numeric" aria-label="<?php echo e(__('Day')); ?>" data-flux-day-input class="<?php echo e($dateInputClasses); ?> w-[calc(2ch+2px)]" />
                                                <input type="text" inputmode="numeric" aria-label="<?php echo e(__('Month')); ?>" data-flux-month-input class="<?php echo e($dateInputClasses); ?> w-[calc(2ch+2px)]" />
                    ...
                    <div class="z-10 absolute top-0 inset-x-0 p-2">
                        <header class="flex justify-between items-center">
                            ...
                            <div class="flex items-center">
                                <?php if ($withToday): ?>
                                    <ui-calendar-today class="size-10 sm:size-8 rounded-lg flex items-center justify-center text-zinc-400 hover:bg-zinc-100 hover:text-zinc-800 dark:hover:bg-white/5 dark:hover:text-white [&[disabled]]:opacity-50 [&[disabled]]:pointer-events-none" aria-label="<?php echo e(__('Previous month')); ?>">
                                        <div class="relative">
                                            <template name="today">
                                ...
                                <ui-calendar-previous class="size-10 sm:size-8 rounded-lg flex items-center justify-center text-zinc-400 hover:bg-zinc-100 hover:text-zinc-800 dark:hover:bg-white/5 dark:hover:text-white [&[disabled]]:opacity-50 [&[disabled]]:pointer-events-none" aria-label="<?php echo e(__('Previous month')); ?>">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 hidden rtl:block"> <path fill-rule="evenodd" d="M8.22 5.22a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06-1.06L11.94 10 8.22 6.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" /> </svg>
                                ...
                                <ui-calendar-next class="size-10 sm:size-8 rounded-lg flex items-center justify-center text-zinc-400 hover:bg-zinc-100 hover:text-zinc-800 dark:hover:bg-white/5 dark:hover:text-white [&[disabled]]:opacity-50 [&[disabled]]:pointer-events-none [&[disabled]_&]:text-zinc-400" aria-label="<?php echo e(__('Next month')); ?>">
...
<?php endif; ?>
<?php /**PATH /home/cristian/proyectos/services-template/vendor/livewire/flux-pro/src/../stubs/resources/views/flux/date-picker/index.blade.php ENDPATH**/ ?>